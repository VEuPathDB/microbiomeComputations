# From https://github.com/emmanuelparadis/ape/blob/master/R/pcoa.R on 10.13.21
# This latest version addresses a pcoa rounding issue that we experienced: https://github.com/emmanuelparadis/ape/issues/17
