...
test_that("betaDiv returns a data.table with the correct attributes" , {
  ...
  expect_equal(names(attr$computedVariables[[1]]$computedVariableMetadata), c('displayName'))
  ...
  expect_equal(attr$computedVariables[[1]]$computedVariableMetadata$displayName, c('Axis1 15.3%','Axis2 5.7%'))
  ...
  expect_equal(attr$computedVariables[[1]]$computedVariableDetails$variableId, c('Axis1','Axis2'))
  expect_equal(attr$computedVariables[[1]]$computedVariableDetails$entityId, rep('entity',2))
  expect_equal(attr$computedVariables[[1]]$computedVariableMetadata$displayName, c('Axis1 10.0%','Axis2 4.3%'))
  ...
  expect_equal(attr$computedVariables[[1]]$computedVariableDetails$variableId, c('Axis1','Axis2'))
  expect_equal(attr$computedVariables[[1]]$computedVariableDetails$entityId, rep('entity',2))
  expect_equal(attr$computedVariables[[1]]$computedVariableMetadata$displayName,c('Axis1 25.2%','Axis2 17.5%'))
...
test_that("betaDivApp output is correctly represented in json", {
  ...
  expect_equal(names(jsonList$computations$computedVariables[[1]]$computedVariableMetadata), c('displayName'))
  expect_equal(jsonList$computations$computedVariables[[1]]$computedVariableMetadata$displayName[[1]], c('Axis1 15.3%','Axis2 5.7%'))
